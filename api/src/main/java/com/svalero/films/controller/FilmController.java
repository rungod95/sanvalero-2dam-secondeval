...
public class FilmController {
    ...
    public ResponseEntity<Film> getFilmById(@PathVariable Long id) {
        ...
        logger.info("Operation completed: film retrieved with ID {}");
    ...
    public ResponseEntity<Film> updateFilm(@PathVariable Long id, @RequestBody Film film) {
        try {
            ...
            logger.info("Operation completed: film with ID {} has been modified");
            return new ResponseEntity<>(updatedFilm, HttpStatus.OK);
        } catch (ResourceNotFoundException e) {
            logger.info("Film not found with id {}");
    ...
    public ResponseEntity<Void> deleteList(@PathVariable Long id) {
        try {
            ...
            logger.info("Operation completed: film deleted with id {}");
